...
\end{thm}
\begin{proof}
    Here, we use the Poisson Semigroup. %TODO ???
    ...
    direction exactly the same way. %TODO correct?
...
\end{thm}
\begin{rmk}
    The factor of $\frac{d}{d-1}$ can be derived using \emph{dimensional analysis}. %DUDE, RIGHT?
